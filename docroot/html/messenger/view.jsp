...
<aui:button-row cssClass="controls">
	...
	<form class="form shindigmsg-entry-form" method="post" action="<%= portletURL.toString() %>">
		<aui:button type="submit" value="de.iisys.shindigmsg.search" cssClass="pull-left" primary="<%= true %>" icon="icon-search" />
		<aui:input name="hashtag" cssClass="autocomplete" type="text" label="" placeholder="#hashtag" />
	</form>
	
	<aui:button onClick="<%= newMessageURL.toString() %>" value="de.iisys.shindigmsg.newMessage" cssClass="pull-right" primary="<%= true %>" icon="icon-comment" />
</aui:button-row>
...
<c:if test="<%= userProfile.isEmpty() %>">
	<liferay-ui:section>
		...
		<div class="pagination pagination-mini pull-right">
			<ul id="<portlet:namespace/>inbox-pages" class="pagination-content"></ul>
		</div>
	...
	<liferay-ui:section>
		...
		<div class="pagination pagination-mini pull-right">
			<ul id="<portlet:namespace/>@wall-pages" class="pagination-content"></ul>
		</div>
		<div style="clear:both;"></div>
	</liferay-ui:section>
...
<c:if test="<%= userProfile.isEmpty() %>">
	<liferay-ui:section>
		...
		<div class="pagination pagination-mini pull-right">
			<ul id="<portlet:namespace/>@outbox-pages" class="pagination-content"></ul>
		</div>
		<div style="clear:both;"></div>
	</liferay-ui:section>
</c:if>
