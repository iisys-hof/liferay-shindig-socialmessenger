...
<% String viewMessageUrlString = "location.href='" + viewMessageURL.toString() + "'"; %>
<liferay-ui:header backURL="<%= viewMessageUrlString.toString() %>" title="de.iisys.shindigmsg.newMessage" />
...
<div class="new-social-message">
	...
	<aui:form action="<%= addMessageURL %>" method="POST" name="fm" label="de.iisys.shindigmsg.newMessage">
		...
		<aui:button-row>
	        ...
	        <aui:button onClick="<%= viewMessageUrlString.toString() %>"  type="cancel" />
	    </aui:button-row>
	</aui:form>
</div>
